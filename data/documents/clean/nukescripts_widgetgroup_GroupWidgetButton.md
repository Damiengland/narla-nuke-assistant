# nukescripts.widgetgroup.GroupWidgetButton
_class _nukescripts.widgetgroup.GroupWidgetButton(_self_ , _parent : Optional] = None_)  None
_class _nukescripts.widgetgroup.GroupWidgetButton(_self_ , _text : str_, _parent : Optional] = None_)  None
...
initStyleOption(_self_ , _option :_)  None
...
setCheckState(_self_ , _state :_)  None
...
setShortcut(_self_ , _arg__1 :_)  None
