...
_class _nukescripts.scripteditorknob.QSplitter(_self_ , _arg__1 :_, _parent : Optional] = None_)  None
_class _nukescripts.scripteditorknob.QSplitter(_self_ , _parent : Optional] = None_)  None
...
addWidget(_self_ , _widget :_)  None
...
insertWidget(_self_ , _index : int_, _widget :_)  None
...
replaceWidget(_self_ , _index : int_, _widget :_)
...
setOrientation(_self_ , _arg__1 :_)  None
