...
nukescripts.set_fileknob_version(_knob_ , _version_)[[source]](../_modules/nukescripts/script.html#set_fileknob_version)
    

Sets version of the filename knob to the passed in version. Throws with ValueError if fileKnob has no version.

[ Previous](nukescripts.selected_vertex_infos.html "nukescripts.selected_vertex_infos") [Next ](nukescripts.setupPyOpenGL.html "nukescripts.setupPyOpenGL")
