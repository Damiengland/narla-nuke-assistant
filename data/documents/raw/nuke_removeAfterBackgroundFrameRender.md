...
nuke.removeAfterBackgroundFrameRender(_call_ , _args =()_, _kwargs ={}_)[[source]](../_modules/nuke_internal/callbacks.html#removeAfterBackgroundFrameRender)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.registerFlipbook.html "nuke.registerFlipbook") [Next ](nuke.removeAfterBackgroundRender.html "nuke.removeAfterBackgroundRender")
