...
nuke.removeOnUserCreate(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#removeOnUserCreate)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeOnScriptSave.html "nuke.removeOnScriptSave") [Next ](nuke.removeRenderProgress.html "nuke.removeRenderProgress")
