...
nuke.removeOnCreate(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#removeOnCreate)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeKnobChanged.html "nuke.removeKnobChanged") [Next ](nuke.removeOnDestroy.html "nuke.removeOnDestroy")
