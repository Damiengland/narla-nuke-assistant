...
nukescripts.dropData(_mimeType_ , _text_)[[source]](../_modules/nukescripts/drop.html#dropData)
    

Handle data drops by invoking the list of callback functions until one has handled the event

[ Previous](nukescripts.degrees.html "nukescripts.degrees") [Next ](nukescripts.ensure_frame_range.html "nukescripts.ensure_frame_range")
