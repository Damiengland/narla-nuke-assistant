...
nukescripts.color_nodes()[[source]](../_modules/nukescripts/nodes.html#color_nodes)
    

Set all selected nodes to be the same colour as the first selected node.

[ Previous](nukescripts.clear_selection_recursive.html "nukescripts.clear_selection_recursive") [Next ](nukescripts.connect_selected_to_viewer.html "nukescripts.connect_selected_to_viewer")
