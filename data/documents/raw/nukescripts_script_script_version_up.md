...
nukescripts.script.script_version_up()[[source]](../_modules/nukescripts/script.html#script_version_up)
    

Increments the versioning in the script name and the path of the timeline write nodes, then saves the new version.

[ Previous](nukescripts.script.script_directory.html "nukescripts.script.script_directory") [Next ](nukescripts.script.set_fileknob_version.html "nukescripts.script.set_fileknob_version")
