...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * [nukescripts.readviewscheck](nukescripts.readviewscheck.html)
      * nukescripts.readviewscheck.checkReadNodeViews
...
nukescripts.readviewscheck.checkReadNodeViews(_read_)[[source]](../_modules/nukescripts/readviewscheck.html#checkReadNodeViews)
    

Check if a read has multiple views, and if so, ask the user if they want to add them to the root node.

[ Previous](nukescripts.readviewscheck.html "nukescripts.readviewscheck") [Next ](nukescripts.readviewscheck.createViews.html "nukescripts.readviewscheck.createViews")
