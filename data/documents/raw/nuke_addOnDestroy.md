...
nuke.addOnDestroy(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#addOnDestroy)
    

Add code to execute when a node is destroyed

[ Previous](nuke.addOnCreate.html "nuke.addOnCreate") [Next ](nuke.addOnScriptClose.html "nuke.addOnScriptClose")
