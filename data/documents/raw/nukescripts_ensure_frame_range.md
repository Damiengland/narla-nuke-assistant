...
nukescripts.ensure_frame_range(_frames_)[[source]](../_modules/nukescripts/geosnap3d.html#ensure_frame_range)
    

If frames is not iterable (i.e it’s a single number) we create an array with the single frame

[ Previous](nukescripts.dropData.html "nukescripts.dropData") [Next ](nukescripts.executeDeferred.html "nukescripts.executeDeferred")
