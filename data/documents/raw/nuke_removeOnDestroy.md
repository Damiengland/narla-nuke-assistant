...
nuke.removeOnDestroy(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#removeOnDestroy)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeOnCreate.html "nuke.removeOnCreate") [Next ](nuke.removeOnScriptClose.html "nuke.removeOnScriptClose")
