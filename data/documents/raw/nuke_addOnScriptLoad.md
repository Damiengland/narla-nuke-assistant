...
nuke.addOnScriptLoad(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Root'_)[[source]](../_modules/nuke_internal/callbacks.html#addOnScriptLoad)
    

Add code to execute when a script is loaded

[ Previous](nuke.addOnScriptClose.html "nuke.addOnScriptClose") [Next ](nuke.addOnScriptSave.html "nuke.addOnScriptSave")
