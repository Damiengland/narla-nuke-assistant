...
nuke.removeOnScriptSave(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Root'_)[[source]](../_modules/nuke_internal/callbacks.html#removeOnScriptSave)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeOnScriptLoad.html "nuke.removeOnScriptLoad") [Next ](nuke.removeOnUserCreate.html "nuke.removeOnUserCreate")
