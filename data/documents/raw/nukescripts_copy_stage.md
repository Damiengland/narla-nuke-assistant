...
nukescripts.copy_stage(_stage_)[[source]](../_modules/nukescripts/geosnap3d.html#copy_stage)
    

Returns a copy of the given stage. This can be expensive so should be avoided where possible.

[ Previous](nukescripts.copy_knobs.html "nukescripts.copy_knobs") [Next ](nukescripts.createCamera.html "nukescripts.createCamera")
