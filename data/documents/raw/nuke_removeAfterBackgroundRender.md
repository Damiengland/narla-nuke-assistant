...
nuke.removeAfterBackgroundRender(_call_ , _args =()_, _kwargs ={}_)[[source]](../_modules/nuke_internal/callbacks.html#removeAfterBackgroundRender)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeAfterBackgroundFrameRender.html "nuke.removeAfterBackgroundFrameRender") [Next ](nuke.removeAfterFrameRender.html "nuke.removeAfterFrameRender")
