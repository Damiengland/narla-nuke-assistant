...
nukescripts.plane_rotation(_tri_ , _norm =None_)[[source]](../_modules/nukescripts/geomath.html#plane_rotation)
...
describe the plane (i.e. they must not be collinear). :rtype: [`Vector3`](nuke.nukemath.Vector3.html#nuke.nukemath.Vector3 "nukemath.Vector3") :return: A _nukemath.Vector3 object where the x coordinate is the angle of rotation around the x axis and so on in radians. :raise ValueError: if the three points are collinear.

[ Previous](nukescripts.planeRotation.html "nukescripts.planeRotation") [Next ](nukescripts.precomp_copyToGroup.html "nukescripts.precomp_copyToGroup")
