...
nuke.removeUpdateUI(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#removeUpdateUI)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeRenderProgress.html "nuke.removeRenderProgress") [Next ](nuke.render.html "nuke.render")
