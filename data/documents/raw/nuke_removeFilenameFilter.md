...
nuke.removeFilenameFilter(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#removeFilenameFilter)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeFavoriteDir.html "nuke.removeFavoriteDir") [Next ](nuke.removeFilenameValidate.html "nuke.removeFilenameValidate")
