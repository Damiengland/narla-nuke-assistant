...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * nukescripts.script
      ...
      * [nukescripts.script.VersionConflictDialog](nukescripts.script.VersionConflictDialog.html)
...
[`findMaxVersionForFileName`](nukescripts.script.findMaxVersionForFileName.html#nukescripts.script.findMaxVersionForFileName "nukescripts.script.findMaxVersionForFileName") | Helper function for finding the max version of a paticular script in it's current directory.  
---|---  
[`get_reads`](nukescripts.script.get_reads.html#nukescripts.script.get_reads "nukescripts.script.get_reads") | Returns file names from all Read nodes.  
[`get_script_data`](nukescripts.script.get_script_data.html#nukescripts.script.get_script_data "nukescripts.script.get_script_data") |   
[`script_and_write_nodes_version_up`](nukescripts.script.script_and_write_nodes_version_up.html#nukescripts.script.script_and_write_nodes_version_up "nukescripts.script.script_and_write_nodes_version_up") |   
[`script_command`](nukescripts.script.script_command.html#nukescripts.script.script_command "nukescripts.script.script_command") |   
[`script_data`](nukescripts.script.script_data.html#nukescripts.script.script_data "nukescripts.script.script_data") |   
[`script_directory`](nukescripts.script.script_directory.html#nukescripts.script.script_directory "nukescripts.script.script_directory") |   
[`script_version_up`](nukescripts.script.script_version_up.html#nukescripts.script.script_version_up "nukescripts.script.script_version_up") | Increments the versioning in the script name and the path of the timeline write nodes, then saves the new version.  
[`set_fileknob_version`](nukescripts.script.set_fileknob_version.html#nukescripts.script.set_fileknob_version "nukescripts.script.set_fileknob_version") | Sets version of the filename knob to the passed in version.  
[`timeline_write_version_set`](nukescripts.script.timeline_write_version_set.html#nukescripts.script.timeline_write_version_set "nukescripts.script.timeline_write_version_set") | Sets the version number in the file path of the 'timeline' write node  
[`version_get`](nukescripts.script.version_get.html#nukescripts.script.version_get "nukescripts.script.version_get") | Extract version information from filenames used by DD (and Weta, apparently) These are _v# or /v# or .v# where v is a prefix string, in our case we use "v" for render version and "c" for camera track version.  
[`version_set`](nukescripts.script.version_set.html#nukescripts.script.version_set "nukescripts.script.version_set") | Changes version information from filenames used by DD (and Weta, apparently) These are _v# or /v# or .v# where v is a prefix string, in our case we use "v" for render version and "c" for camera track version.  
  
Classes

[`VersionConflictDialog`](nukescripts.script.VersionConflictDialog.html#nukescripts.script.VersionConflictDialog "nukescripts.script.VersionConflictDialog") | Dialog which gives the user options for resolving version conflicts  
---|---  
[`VersionHelper`](nukescripts.script.VersionHelper.html#nukescripts.script.VersionHelper "nukescripts.script.VersionHelper") | Helper class for storing the new version information  
  
[ Previous](nukescripts.run_framecycler.run_app.html "nukescripts.run_framecycler.run_app") [Next ](nukescripts.script.findMaxVersionForFileName.html "nukescripts.script.findMaxVersionForFileName")
