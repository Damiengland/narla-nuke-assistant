...
_class _nukescripts.renderdialog.DialogState[[source]](../_modules/nukescripts/renderdialog.html#DialogState)
...
get(_knob_ , _defaultValue =None_)[[source]](../_modules/nukescripts/renderdialog.html#DialogState.get)
...
getValue(_id_ , _defaultValue =None_)[[source]](../_modules/nukescripts/renderdialog.html#DialogState.getValue)
    

Recalls the value. If it was not set before, it will return the defaultValue.

save(_knob_)[[source]](../_modules/nukescripts/renderdialog.html#DialogState.save)
...
saveValue(_id_ , _value_)[[source]](../_modules/nukescripts/renderdialog.html#DialogState.saveValue)
    

Stores the value with the given id.

setKnob(_knob_ , _defaultValue =None_)[[source]](../_modules/nukescripts/renderdialog.html#DialogState.setKnob)
    

Convenience method for setting a value straight on a knob.

[ Previous](nukescripts.renderdialog.showViewerCaptureDialog.html "nukescripts.renderdialog.showViewerCaptureDialog") [Next ](nukescripts.renderdialog.ExecuteDialog.html "nukescripts.renderdialog.ExecuteDialog")
