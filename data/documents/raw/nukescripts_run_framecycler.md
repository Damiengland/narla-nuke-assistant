...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * nukescripts.run_framecycler
      * [nukescripts.run_framecycler.framecycler_linux_version](nukescripts.run_framecycler.framecycler_linux_version.html)
      * [nukescripts.run_framecycler.framecycler_sequence](nukescripts.run_framecycler.framecycler_sequence.html)
      * [nukescripts.run_framecycler.framecycler_stereo_available](nukescripts.run_framecycler.framecycler_stereo_available.html)
      * [nukescripts.run_framecycler.framecycler_this](nukescripts.run_framecycler.framecycler_this.html)
      * [nukescripts.run_framecycler.run_app](nukescripts.run_framecycler.run_app.html)
...
[`framecycler_linux_version`](nukescripts.run_framecycler.framecycler_linux_version.html#nukescripts.run_framecycler.framecycler_linux_version "nukescripts.run_framecycler.framecycler_linux_version") |   
---|---  
[`framecycler_sequence`](nukescripts.run_framecycler.framecycler_sequence.html#nukescripts.run_framecycler.framecycler_sequence "nukescripts.run_framecycler.framecycler_sequence") |   
[`framecycler_stereo_available`](nukescripts.run_framecycler.framecycler_stereo_available.html#nukescripts.run_framecycler.framecycler_stereo_available "nukescripts.run_framecycler.framecycler_stereo_available") | This function used to detect if we were running on Mac OS Tiger; we no longer support Tiger, so this function always returns true now.  
[`framecycler_this`](nukescripts.run_framecycler.framecycler_this.html#nukescripts.run_framecycler.framecycler_this "nukescripts.run_framecycler.framecycler_this") | Run framecycler on a Read or Write node.  
[`run_app`](nukescripts.run_framecycler.run_app.html#nukescripts.run_framecycler.run_app "nukescripts.run_framecycler.run_app") |   
  
[ Previous](nukescripts.rollingAutoSave.onAutoSaveRestore.html "nukescripts.rollingAutoSave.onAutoSaveRestore") [Next ](nukescripts.run_framecycler.framecycler_linux_version.html "nukescripts.run_framecycler.framecycler_linux_version")
