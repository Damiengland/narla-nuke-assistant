...
nuke.addAfterRecording(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Viewer'_)[[source]](../_modules/nuke_internal/callbacks.html#addAfterRecording)
    

Add code to execute after viewer recording

[ Previous](nuke.addAfterFrameRender.html "nuke.addAfterFrameRender") [Next ](nuke.addAfterRender.html "nuke.addAfterRender")
