...
nuke.removeBeforeBackgroundRender(_call_ , _args =()_, _kwargs ={}_)[[source]](../_modules/nuke_internal/callbacks.html#removeBeforeBackgroundRender)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeAutolabel.html "nuke.removeAutolabel") [Next ](nuke.removeBeforeFrameRender.html "nuke.removeBeforeFrameRender")
