...
_class _nukescripts.scripteditorknob.QSplitter(_self_ , _arg__1 : [PySide6.QtCore.Qt.Orientation](nukescripts.widgetgroup.Qt.html#nukescripts.widgetgroup.Qt.Orientation "PySide6.QtCore.Qt.Orientation")_, _parent : Optional[[PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")] = None_) → None
_class _nukescripts.scripteditorknob.QSplitter(_self_ , _parent : Optional[[PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")] = None_) → None
...
addWidget(_self_ , _widget : [PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")_) → None
...
changeEvent(_self_ , _arg__1 : PySide6.QtCore.QEvent_) → None
...
childEvent(_self_ , _arg__1 : PySide6.QtCore.QChildEvent_) → None
    

children(_self_) → List[PySide6.QtCore.QObject]
    

childrenCollapsible(_self_) → bool
...
closestLegalPosition(_self_ , _arg__1 : int_, _arg__2 : int_) → int
...
createHandle(_self_) → PySide6.QtWidgets.QSplitterHandle
...
getRange(_self_ , _index : int_) → object
...
handle(_self_ , _index : int_) → PySide6.QtWidgets.QSplitterHandle
    

handleWidth(_self_) → int
...
indexOf(_self_ , _w : [PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")_) → int
...
insertWidget(_self_ , _index : int_, _widget : [PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")_) → None
...
isCollapsible(_self_ , _index : int_) → bool
...
moveSplitter(_self_ , _pos : int_, _index : int_) → None
...
opaqueResize(_self_) → bool
    

orientation(_self_) → [PySide6.QtCore.Qt.Orientation](nukescripts.widgetgroup.Qt.html#nukescripts.widgetgroup.Qt.Orientation "PySide6.QtCore.Qt.Orientation")
...
replaceWidget(_self_ , _index : int_, _widget : [PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")_) → [PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")
...
restoreState(_self_ , _state : Union[PySide6.QtCore.QByteArray, bytes]_) → bool
    

saveGeometry(_self_) → PySide6.QtCore.QByteArray
    

saveState(_self_) → PySide6.QtCore.QByteArray
...
setChildrenCollapsible(_self_ , _arg__1 : bool_) → None
    

setCollapsible(_self_ , _index : int_, _arg__2 : bool_) → None
...
setHandleWidth(_self_ , _arg__1 : int_) → None
...
setOpaqueResize(_self_ , _opaque : bool = True_) → None
    

setOrientation(_self_ , _arg__1 : [PySide6.QtCore.Qt.Orientation](nukescripts.widgetgroup.Qt.html#nukescripts.widgetgroup.Qt.Orientation "PySide6.QtCore.Qt.Orientation")_) → None
...
setRubberBand(_self_ , _position : int_) → None
...
setSizes(_self_ , _list : Sequence[int]_) → None
    

setStatusTip(_self_ , _arg__1 : str_) → None
    

setStretchFactor(_self_ , _index : int_, _stretch : int_) → None
...
widget(_self_ , _index : int_) → [PySide6.QtWidgets.QWidget](nukescripts.widgetgroup.QWidget.html#nukescripts.widgetgroup.QWidget "PySide6.QtWidgets.QWidget")
...
[ Previous](nukescripts.scripteditorknob.QPlainTextEdit.html "nukescripts.scripteditorknob.QPlainTextEdit") [Next ](nukescripts.scripteditorknob.QVBoxLayout.html "nukescripts.scripteditorknob.QVBoxLayout")
