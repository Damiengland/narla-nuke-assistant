...
nukescripts.showname()[[source]](../_modules/nukescripts/misc.html#showname)
    

Shows the current script path and, if the selected node is a Read or Write node, the filename from it.

[ Previous](nukescripts.showReportDialog.html "nukescripts.showReportDialog") [Next ](nukescripts.splitInSequence.html "nukescripts.splitInSequence")
