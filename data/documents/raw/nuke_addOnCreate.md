...
nuke.addOnCreate(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#addOnCreate)
    

Add code to execute when a node is created or undeleted

[ Previous](nuke.addNodePresetExcludePaths.html "nuke.addNodePresetExcludePaths") [Next ](nuke.addOnDestroy.html "nuke.addOnDestroy")
