...
nukescripts.new3D(_node_)[[source]](../_modules/nukescripts/unrealreader.html#new3D)
    

Checks if the node is using the new 3D system.

[ Previous](nukescripts.need_stage_copy.html "nukescripts.need_stage_copy") [Next ](nukescripts.nodeIsInside.html "nukescripts.nodeIsInside")
