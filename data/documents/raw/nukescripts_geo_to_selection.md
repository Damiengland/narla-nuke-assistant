...
nukescripts.geo_to_selection(_node_to_snap_ , _frames_ , _translate_enabled_ , _rotate_enabled_ , _scale_enabled_ , _animate_single_frame =False_, _stage =None_, _task =None_)[[source]](../_modules/nukescripts/geosnap3d.html#geo_to_selection)
...
Parameters
  ...
  * **node_to_snap** ([_nuke.Node_](nuke.Node.html#nuke.Node "nuke.Node")) – Node to translate/rotate/scale
  ...
  * **task** ([_nuke.ProgressTask_](nuke.ProgressTask.html#nuke.ProgressTask "nuke.ProgressTask")) – An optional progress task that will update as frames are processed.
...
[ Previous](nukescripts.fuzzy_vector3_add.html "nukescripts.fuzzy_vector3_add") [Next ](nukescripts.getAxisKnobPrefix.html "nukescripts.getAxisKnobPrefix")
