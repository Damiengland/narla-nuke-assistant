...
nuke.removeAfterRender(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Write'_)[[source]](../_modules/nuke_internal/callbacks.html#removeAfterRender)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeAfterRecording.html "nuke.removeAfterRecording") [Next ](nuke.removeAfterReplay.html "nuke.removeAfterReplay")
