...
nuke.addOnScriptClose(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Root'_)[[source]](../_modules/nuke_internal/callbacks.html#addOnScriptClose)
    

Add code to execute before a script is closed

[ Previous](nuke.addOnDestroy.html "nuke.addOnDestroy") [Next ](nuke.addOnScriptLoad.html "nuke.addOnScriptLoad")
