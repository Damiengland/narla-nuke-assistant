...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * [nukescripts.pyQtExamples](nukescripts.pyQtExamples.html)
      * [nukescripts.pyQtExamples.flipbookingExample](nukescripts.pyQtExamples.flipbookingExample.html)
        * nukescripts.pyQtExamples.flipbookingExample.ExampleRVFlipbook
      * [nukescripts.pyQtExamples.pyQtRender](nukescripts.pyQtExamples.pyQtRender.html)
      * [nukescripts.pyQtExamples.pyQtRender2](nukescripts.pyQtExamples.pyQtRender2.html)
...
_class _nukescripts.pyQtExamples.flipbookingExample.ExampleRVFlipbook[[source]](../_modules/nukescripts/pyQtExamples/flipbookingExample.html#ExampleRVFlipbook)
    

Bases: [`nukescripts.flipbooking.FlipbookApplication`](nukescripts.flipbooking.FlipbookApplication.html#nukescripts.flipbooking.FlipbookApplication "nukescripts.flipbooking.FlipbookApplication")
...
cacheDir()[[source]](../_modules/nukescripts/pyQtExamples/flipbookingExample.html#ExampleRVFlipbook.cacheDir)
    

Return the preferred directory for rendering. :return: String

capabilities()[[source]](../_modules/nukescripts/pyQtExamples/flipbookingExample.html#ExampleRVFlipbook.capabilities)
...
name()[[source]](../_modules/nukescripts/pyQtExamples/flipbookingExample.html#ExampleRVFlipbook.name)
    

Return the name of the flipbook. :return: String

path()[[source]](../_modules/nukescripts/pyQtExamples/flipbookingExample.html#ExampleRVFlipbook.path)
    

Return the executable path required to run a flipbook. :return: String

run(_filename_ , _frameRanges_ , _views_ , _options_)[[source]](../_modules/nukescripts/pyQtExamples/flipbookingExample.html#ExampleRVFlipbook.run)
...
[ Previous](nukescripts.pyQtExamples.flipbookingExample.html "nukescripts.pyQtExamples.flipbookingExample") [Next ](nukescripts.pyQtExamples.pyQtRender.html "nukescripts.pyQtExamples.pyQtRender")
