...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * [nukescripts.select](nukescripts.select.html)
      ...
      * nukescripts.select.select_similar
...
nukescripts.select.select_similar(__type_)[[source]](../_modules/nukescripts/select.html#select_similar)
    

Included only for compatibility. Use nuke.selectSimilar().

[ Previous](nukescripts.select.select_by_name.html "nukescripts.select.select_by_name") [Next ](nukescripts.snap3d.html "nukescripts.snap3d")
