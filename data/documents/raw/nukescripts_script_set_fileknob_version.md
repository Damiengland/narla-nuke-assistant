...
nukescripts.script.set_fileknob_version(_knob_ , _version_)[[source]](../_modules/nukescripts/script.html#set_fileknob_version)
    

Sets version of the filename knob to the passed in version. Throws with ValueError if fileKnob has no version.

[ Previous](nukescripts.script.script_version_up.html "nukescripts.script.script_version_up") [Next ](nukescripts.script.timeline_write_version_set.html "nukescripts.script.timeline_write_version_set")
