...
nuke.addOnScriptSave(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Root'_)[[source]](../_modules/nuke_internal/callbacks.html#addOnScriptSave)
    

Add code to execute before a script is saved

[ Previous](nuke.addOnScriptLoad.html "nuke.addOnScriptLoad") [Next ](nuke.addOnUserCreate.html "nuke.addOnUserCreate")
