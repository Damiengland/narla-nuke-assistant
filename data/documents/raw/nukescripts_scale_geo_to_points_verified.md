...
nukescripts.scale_geo_to_points_verified(_node_to_snap_ , _vertex_selection_ , _animate_enabled =False_, _current_frame =None_)[[source]](../_modules/nukescripts/geosnap3d.html#scale_geo_to_points_verified)
    

Scale the geometry to the vertex selection (does not check for required conditions)

[ Previous](nukescripts.scaleToPointsVerified.html "nukescripts.scaleToPointsVerified") [Next ](nukescripts.scalingMatrix.html "nukescripts.scalingMatrix")
