...
nukescripts.on_snap_knob(_origin_knob_ , _command_)[[source]](../_modules/nukescripts/geosnap3d.html#on_snap_knob)
...
Parameters
  ...
  * **origin_knob** ([_nuke.Knob_](nuke.Knob.html#nuke.Knob "nuke.Knob")) – Knob that was used to start this operation. This is used to determine the operation to perform as well as finding the parameters for the operation from other related snap knobs on the node.
...
[ Previous](nukescripts.node_delete.html "nukescripts.node_delete") [Next ](nukescripts.parseUdimFile.html "nukescripts.parseUdimFile")
