...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * nukescripts.unrealreader
      * [nukescripts.unrealreader.cameraClass](nukescripts.unrealreader.cameraClass.html)
      * [nukescripts.unrealreader.createCamera](nukescripts.unrealreader.createCamera.html)
      * [nukescripts.unrealreader.createReadNode](nukescripts.unrealreader.createReadNode.html)
      * [nukescripts.unrealreader.new3D](nukescripts.unrealreader.new3D.html)
...
[`cameraClass`](nukescripts.unrealreader.cameraClass.html#nukescripts.unrealreader.cameraClass "nukescripts.unrealreader.cameraClass") | Returns the correct camera class for the 3D system in use.  
---|---  
[`createCamera`](nukescripts.unrealreader.createCamera.html#nukescripts.unrealreader.createCamera "nukescripts.unrealreader.createCamera") | Create a camera node based on the values set in the given unreal reader node  
[`createReadNode`](nukescripts.unrealreader.createReadNode.html#nukescripts.unrealreader.createReadNode "nukescripts.unrealreader.createReadNode") | Create a read node for the rendered output  
[`new3D`](nukescripts.unrealreader.new3D.html#nukescripts.unrealreader.new3D "nukescripts.unrealreader.new3D") | Checks if the node is using the new 3D system.  
  
[ Previous](nukescripts.udim.UDIMOptionsDialog.html "nukescripts.udim.UDIMOptionsDialog") [Next ](nukescripts.unrealreader.cameraClass.html "nukescripts.unrealreader.cameraClass")
