...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * nukescripts.select
      * [nukescripts.select.select_by_name](nukescripts.select.select_by_name.html)
      * [nukescripts.select.select_similar](nukescripts.select.select_similar.html)
...
[`select_by_name`](nukescripts.select.select_by_name.html#nukescripts.select.select_by_name "nukescripts.select.select_by_name") | Menu command to select nodes by a glob-pattern name.  
---|---  
[`select_similar`](nukescripts.select.select_similar.html#nukescripts.select.select_similar "nukescripts.select.select_similar") | Included only for compatibility.  
  
[ Previous](nukescripts.searchreplace.search_replace.html "nukescripts.searchreplace.search_replace") [Next ](nukescripts.select.select_by_name.html "nukescripts.select.select_by_name")
