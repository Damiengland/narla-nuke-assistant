...
nuke.removeDefaultColorspaceMapper(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/colorspaces.html#removeDefaultColorspaceMapper)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeBeforeReplay.html "nuke.removeBeforeReplay") [Next ](nuke.removeFavoriteDir.html "nuke.removeFavoriteDir")
