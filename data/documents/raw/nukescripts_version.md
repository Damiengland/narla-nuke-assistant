...
API Reference
  ...
  * [nukescripts](nukescripts.html)
    ...
    * nukescripts.version
      * [nukescripts.version.version_down](nukescripts.version.version_down.html)
      * [nukescripts.version.version_get](nukescripts.version.version_get.html)
      * [nukescripts.version.version_latest](nukescripts.version.version_latest.html)
      * [nukescripts.version.version_set](nukescripts.version.version_set.html)
      * [nukescripts.version.version_up](nukescripts.version.version_up.html)
...
[`version_down`](nukescripts.version.version_down.html#nukescripts.version.version_down "nukescripts.version.version_down") | All new version_down that uses the version_get/set functions.  
---|---  
[`version_get`](nukescripts.version.version_get.html#nukescripts.version.version_get "nukescripts.version.version_get") | Extract version information from filenames used by DD (and Weta, apparently) These are _v# or /v# or .v# where v is a prefix string, in our case we use "v" for render version and "c" for camera track version.  
[`version_latest`](nukescripts.version.version_latest.html#nukescripts.version.version_latest "nukescripts.version.version_latest") | Like version_up, but only goes up to the highest numbered version that exists.  
[`version_set`](nukescripts.version.version_set.html#nukescripts.version.version_set "nukescripts.version.version_set") | Changes version information from filenames used by DD (and Weta, apparently) These are _v# or /v# or .v# where v is a prefix string, in our case we use "v" for render version and "c" for camera track version.  
[`version_up`](nukescripts.version.version_up.html#nukescripts.version.version_up "nukescripts.version.version_up") | All new version_up that uses the version_get/set functions.  
  
[ Previous](nukescripts.utils.findNextNodeName.html "nukescripts.utils.findNextNodeName") [Next ](nukescripts.version.version_down.html "nukescripts.version.version_down")
