...
nukescripts.snap3d.transformMatrix(_nodeToSnap_)[[source]](../_modules/nukescripts/snap3d.html#transformMatrix)
...
**nodeToSnap** ([_nuke.Node_](nuke.Node.html#nuke.Node "nuke.Node")) – Node from which the data will be extracted to generate its transformation matrix.

Return type
    

[`Matrix4`](nuke.nukemath.Matrix4.html#nuke.nukemath.Matrix4 "nukemath.Matrix4")
...
[ Previous](nukescripts.snap3d.selectedVertexInfos.html "nukescripts.snap3d.selectedVertexInfos") [Next ](nukescripts.snap3d.translateMatrix.html "nukescripts.snap3d.translateMatrix")
