...
_class _nukescripts.FlipbookApplication[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication)
...
cacheDir()[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.cacheDir)
    

Return the preferred directory for rendering. :return: String

capabilities()[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.capabilities)
...
dialogKnobChanged(_dialog_ , _knob_)[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.dialogKnobChanged)
...
dialogKnobs(_dialog_)[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.dialogKnobs)
...
getExtraOptions(_flipbookDialog_ , _nodeToFlipbook_)[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.getExtraOptions)
...
name()[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.name)
    

Return the name of the flipbook. :return: String

path()[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.path)
    

Return the executable path required to run a flipbook. :return: String

run(_path_ , _frameRanges_ , _views_ , _options_)[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.run)
...
runFromNode(_nodeToFlipbook_ , _frameRanges_ , _views_ , _options_)[[source]](../_modules/nukescripts/flipbooking.html#FlipbookApplication.runFromNode)
...
[ Previous](nukescripts.BlinkscriptEditorWidgetKnob.html "nukescripts.BlinkscriptEditorWidgetKnob") [Next ](nukescripts.FlipbookFactory.html "nukescripts.FlipbookFactory")
