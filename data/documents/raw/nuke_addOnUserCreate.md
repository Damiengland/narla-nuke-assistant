...
nuke.addOnUserCreate(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='*'_)[[source]](../_modules/nuke_internal/callbacks.html#addOnUserCreate)
    

Add code to execute when user creates a node

[ Previous](nuke.addOnScriptSave.html "nuke.addOnScriptSave") [Next ](nuke.addRenderProgress.html "nuke.addRenderProgress")
