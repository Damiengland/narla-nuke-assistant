...
_class _nukescripts.pyAppUtils.pyAppHelper(_start =None_)[[source]](../_modules/nukescripts/pyAppUtils.html#pyAppHelper)
...
initiate()[[source]](../_modules/nukescripts/pyAppUtils.html#pyAppHelper.initiate)
    

Start the thread associated with this object

run(_call_ , _args =()_, _kwargs ={}_)[[source]](../_modules/nukescripts/pyAppUtils.html#pyAppHelper.run)
    

Runs the specified call in a separate thread.

terminate()[[source]](../_modules/nukescripts/pyAppUtils.html#pyAppHelper.terminate)
    

Terminated the thread associated with this object

[ Previous](nukescripts.pyAppUtils.html "nukescripts.pyAppUtils") [Next ](nukescripts.pyQtAppUtils.html "nukescripts.pyQtAppUtils")
