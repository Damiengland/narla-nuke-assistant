...
nukescripts.get_node_transform_matrix(_node_to_snap_ , _current_frame_)[[source]](../_modules/nukescripts/geosnap3d.html#get_node_transform_matrix)
...
**node_to_snap** ([_nuke.Node_](nuke.Node.html#nuke.Node "nuke.Node")) – Node from which the data will be extracted to generate its transformation matrix.
...
[ Previous](nukescripts.get_fully_qualified_name.html "nukescripts.get_fully_qualified_name") [Next ](nukescripts.get_prim_world_rotation_zxy.html "nukescripts.get_prim_world_rotation_zxy")
