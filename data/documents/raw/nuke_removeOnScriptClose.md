...
nuke.removeOnScriptClose(_call_ , _args =()_, _kwargs ={}_, _nodeClass ='Root'_)[[source]](../_modules/nuke_internal/callbacks.html#removeOnScriptClose)
    

Remove a previously-added callback with the same arguments.

[ Previous](nuke.removeOnDestroy.html "nuke.removeOnDestroy") [Next ](nuke.removeOnScriptLoad.html "nuke.removeOnScriptLoad")
